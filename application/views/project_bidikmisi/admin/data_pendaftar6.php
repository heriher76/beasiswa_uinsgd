			...
			<div class="col-md-6">
				<div class="box">
					<div class="box-header">
						<h3 class="box-title">Filter Berdasarkan Fakultas</h3>
					</div>

					<div class="box-body">
						<form action="<?=base_url('Auth1/v_report_fakultas2'); ?>" method="POST">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="box">
					...
					<div class="box-body">
						<table id="pendaftar2" class="display table table-responsive table-bordered table-striped" style="width:100%;">
