					...
					<div class="box">
						<div class="box-header">
						    ...
						    <div class="alert alert-info text-center" style="color:#ffffff; font-size:16px;">
					            <p><b><?php echo $value->nama_mahasiswa; ?> Mendaftar Bidikmisi pada Hari/Tanggal </br><i><?php echo tgl_indonesia($value->registeredon); ?></i></b><p>
					        </div>
							...
							<form action="<?=base_url().'Auth0/berkasDiterimaOleh/'.sha1(md5(sha1(md5(sha1($value->no_pendaftaran))))); ?>" method="POST">
