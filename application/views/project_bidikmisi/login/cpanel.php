	...
	<body>
		<div class="user-login">
			...
			<div class="col-md-12 col-xd-12 col-sm-12">
				<!--Form Login-->
				<br><br><br>
				<center><div style="height: 100%; width: auto; max-width: 600px;">
					<div class="pnl panel panel-info">
						...
						<div class="panel-body">
							<div class="alert alert-success">
								...
								<p><b>1)</b> Gunakan Nomor Pendaftaran dan tanggal lahir jika ingin mendaftar Beasiswa KIP-K</p>
								<p><b>2)</b> Gunakan akun salam jika ingin melaporkan prestasi akademik</p>
							</div>
