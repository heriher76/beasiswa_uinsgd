	...
	<footer class="main-footer">
		<strong>Managed by &copy; 2018 <a href="http://ptipd.uinsgd.ac.id/" target="_blank">PTIPD - Universitas Islam Negeri Sunan Gunung Djati Bandung</a>.</strong> All rights reserved.
	</footer>
	<!--End Footer-->
	...
	<!--script type="text/Javascript" src="<?=base_url('assets/t/d/js/dataTables.bootstrap4.min.js'); ?>"></script-->
	...
	<script type="text/Javascript">
	        ...
	        $(document).ready(function(){ //ketika halaman sudah selesai di load
	        	...
	        	$('#provinsi10').change(function(){ //ketika user mengganti dan memilih data provinsi
	        		...
	        		$.ajax({
	        			type: "POST", //method pengiriman data bisa dengan GET atau POST
	        			url: "<?=base_url('Auth1/listprovinsi'); ?>", //menuju URL function yang ada dicontroller C_mhs
